# -*- coding: utf-8 -*-
#
# baxter_tasker documentation build configuration file, created by
...
project = u'baxter_tasker'
copyright = u'2014, HumaRobotics'
...
htmlhelp_basename = 'baxter_taskerdoc'
...
latex_documents = [
  ('index', 'baxter_tasker.tex', u'baxter\\_tasker Documentation',
   u'HumaRobotics', 'manual'),
]
...
man_pages = [
    ('index', 'baxter_tasker', u'baxter_tasker Documentation',
     [u'HumaRobotics'], 1)
]
...
texinfo_documents = [
  ('index', 'baxter_tasker', u'baxter_tasker Documentation',
   u'HumaRobotics', 'baxter_tasker', 'One line description of project.',
   'Miscellaneous'),
]
